...
UPDATE_PACKAGE "lucky" "K1002H/luci-app-lucky/tree/v2.4.8" "master" "pkg"
...
UPDATE_PACKAGE "luci-app-pgyvpn" "kiddin9/openwrt-packages" "master" "pkg"
...
UPDATE_PACKAGE "luci-app-lucky" "K1002H/luci-app-lucky/tree/v2.4.8" "master" "pkg"
